...
/**
 * This file is used to register required plugins for the theme.
 *
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'    => get_stylesheet_directory() . '/plugins/acf-cf7-master.zip',
			'required'  => true,
		),
		...
		array(
			...
			'slug'      => 'kau-boys-backend-localization',
			'required'  => true,
		),
